/**
 * File: csci1302/lab10/MileageCalculatorNoConversion.java
 * Package: ch16
 * @author Christopher Williams, Jake Caruana editted
...
public class MileageCalculatorNoConversion extends Application {
    ...
    private ComboBox<String> cmbUnits = new ComboBox<>(items);
    ...
    public void start(Stage primaryStage) {   	
        ...
        cmbUnits.setOnAction(e -> changeLabels());     
    ...
    private void changeLabels() {
    	...
    	if (cmbUnits.getValue() == altResult && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
    ...
    private void calcMileage() {       
        ...
        double result = 0.0;
        if (cmbUnits.getValue() == altResult) {
        	// liters / 100KM
